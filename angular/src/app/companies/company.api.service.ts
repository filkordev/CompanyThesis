...
export class CompanyApiService{
    ...
    getCompanies(): Observable<Company[]>{
        ...
        return this.http.get('/companies?token=' + token)
        .map(
            (res: Response) => {
    ...
    getCompany(id: number): Observable<Company>{
        ...
        return this.http.get('/company/' + id + '?token=' + token)
        .map(
            (res: Response) => {
    ...
    addCompany(company: Company): Observable<any>{
        ...
        return this.http.post('/company?token=' + token, body, {headers: headers});
    }
    ...
    updateCompany(company: Company): Observable<any>{
        ...
        const headers = new HttpHeaders({'Content-Type': 'application/json'});
        const body = this.companyToDatabase(company);
        return this.http.put('/company/' + company.id + '?token=' + token, body, {headers: headers});
    }
    ...
    deleteCompany(company: Company | number): Observable<any>{
        ...
        const token = this.authService.getToken();
        return this.http.delete('/company/' + id + '?token=' + token);
    }

    getCountries(): Observable<Country[]>{
        const token = this.authService.getToken();
        return this.http.get('/countries?token=' + token)
        .map(
            (res: Response) => {
    ...
    getEmployeesnumbers(): Observable<EmployeesNumber[]>{
        const token = this.authService.getToken();
        return this.http.get('/employeesnumbers?token=' + token)
        .map(
            (res: Response) => {
    ...
    getIndustries(): Observable<Industry[]>{
        const token = this.authService.getToken();
        return this.http.get('/industries?token=' + token)
        .map(
            (res: Response) => {
    ...
    getYearlyincomes(): Observable<YearlyIncome[]>{
        const token = this.authService.getToken();
        return this.http.get('/yearlyincomes?token=' + token)
        .map(
            (res: Response) => {
