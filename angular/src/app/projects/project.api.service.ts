...
export class ProjectApiService{
    ...
    getProjects(): Observable<Project[]>{
        ...
        return this.http.get('/projects?token=' + token)
        .map(
            (res: Response) => {
    ...
    getProject(id: number): Observable<Project>{
        ...
        return this.http.get('/project/' + id + '?token=' + token)
        .map(
            (res: Response) => {
    ...
    addProject(project: Project): Observable<any>{
        ...
        return this.http.post('/project?token=' + token, body, {headers: headers});
    }
    ...
    updateProject(project: Project): Observable<any>{
        ...
        const headers = new HttpHeaders({'Content-Type': 'application/json'});
        const body = this.projectToDatabase(project);
        return this.http.put('/project/' + project.id + '?token=' + token, body, {headers: headers});
    }
    ...
    deleteProject(project: Project | number): Observable<any>{
        ...
        const token = this.authService.getToken();
        return this.http.delete('/project/' + id + '?token=' + token);
    }

    getStatuses(): Observable<Status[]>{
        const token = this.authService.getToken();
        return this.http.get('/statuses?token=' + token)
        .map(
            (res: Response) => {
    ...
    getPriorities(): Observable<Priority[]>{
        const token = this.authService.getToken();
        return this.http.get('/priorities?token=' + token)
        .map(
            (res: Response) => {
    ...
    getCurrencies(): Observable<Currency[]>{
        const token = this.authService.getToken();
        return this.http.get('/currencies?token=' + token)
        .map(
            (res: Response) => {
